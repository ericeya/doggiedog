              ...
              <form className="space-y-6" action="#" method="POST" onSubmit={submitHandler}>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-sm leading-6">
                    <a href="#" className="font-semibold text-gray-800 hover:text-red-400">
                      Forgot password?
                    </a>
                  </div>
                </div>
                ...
                <div>
                  <button
                    type="submit"
                    className="flex w-full justify-center rounded-md bg-[#D48C70] px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-[#F08C70] duration-100 ease-in-out focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-200"
                  >
                    Sign in
                  </button>
                </div>
